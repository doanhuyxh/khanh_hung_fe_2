...
const LessonItemAdmin: React.FC<LessonItemProps> = ({
    ...
    return (
        <div className='w-full flex justify-between items-center gap-4 shadow-lg px-4 py-5 mb-6 rounded-lg cursor-pointer relative group'>
            ...
            <div className="absolute bottom-1/4 right-1/4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
